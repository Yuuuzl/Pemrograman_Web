...
if (isset($_POST['login'])) {                                                                           // Membuat metode POST                                                                      
    ...
    $message = "";                                           
        if ($username == "wahyu" && $password == "wahyuganteng") {                                             // Cek apakah username dan password sesuai
            //membuat session
            $_SESSION['login'] = $username;
            header("location:Landingpage.php"); //mengarah ke page Landingpage.php     
        } else {
...
<head>
    ...
    <title>Studi Kasus Modul 10</title>
